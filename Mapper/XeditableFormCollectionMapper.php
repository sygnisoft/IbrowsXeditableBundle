...
class XeditableFormCollectionMapper extends AbstractFormXeditableMapper
{
     ...
     */
    public function __construct(FormInterface $form, $formData, array $routeNames, array $routeParams, EngineInterface $engine, Router $router)
    {
        $this->form = $form;
    ...
    protected function getRenderCollectionSubFormTemplate($key, $options)
    {
